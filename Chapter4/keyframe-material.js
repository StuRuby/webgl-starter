...
MaterialApp.prototype.init = function (params) {
...
MaterialApp.prototype.createObjects = function () {
    ...
    this.ballmaterial = new THREE.MeshPhongMaterial({ color: 0xff0000, ambient: 0x222222, transparent: true });
    ...
    this.cylindermaterial = new THREE.MeshPhongMaterial({ color: 0xcccccc, shininess: 1, specular: 0xffff00 });
